...
and sends a clearly formatted Telegram alert whenever one of them:
  ...
  - buys / swaps a token   -> shows what was paid, what token was bought, its NAME + CA

Config is read from environment variables when available (used on GitHub Actions),
falling back to the hardcoded values below (handy for quick tests on Replit).
...
# ================= CONFIG =================
HELIUS_API_KEY = os.environ.get("HELIUS_API_KEY", "8386d541-876c-4b07-81a4-2ad91c526171")
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "8752214815:AAFdTSJnx48W_q6ik1PE5-GiX4K8xQER_XY")
TELEGRAM_CHAT_ID = os.environ.get("TELEGRAM_CHAT_ID", "7800248450")
